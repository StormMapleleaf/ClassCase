...
// 配置验证码插件的使用路由
Route::get('/demo/captcha', [DemoController::class, 'createCaptcha']);
// 生成二维码的路由配置
Route::get('/demo/qrcode', [DemoController::class, 'createQrcode']);


// 配置测试自定义Stu的Model类路由
Route::get('/demo/stu-model', [DemoController::class, 'stuModel']);
